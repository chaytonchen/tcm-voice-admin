      ...
      <view class="edit-box">
        ...
        <view class="settings">
          ...
          <uni-forms-item name="thumbnail" label="封面" required>
            ...
            <view class="thumbnail-list" v-if="thumbMode > 0">
              <view class="thumbnail" v-for="(thumbnail, index) in formData.thumbnail" :key="thumbnail.source">
                ...
                <template v-else>
                  <uni-icons @click="() => openInsertImageDrawer(index)" class="placeholder" type="plusempty" size="60"
                    color="#e8e8e8"></uni-icons>
                </template>
              </view>
            </view>
          ...
          <uni-forms-item name="category_id" label="分类">
            <uni-data-picker v-model="formData.category_id" style="width: 200px;" collection="uni-cms-categories"
      ...
      <view class="wrap">
        ...
        <view class="right">
          <view class="uni-button-group">
            <!-- #ifdef H5 -->
            <button v-if="formData.article_status === 0" class="uni-button" style="width: 100px;margin-right: 10px;"
              @click="previewArticle">预览</button>
            <!-- #endif -->
            <button v-if="formData.article_status === 0" class="uni-button" style="width: 100px;margin-right: 10px;"
              @click="submit(0)">保存</button>
