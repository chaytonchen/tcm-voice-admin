  ...
  <view>
    <view class="uni-header">
      ...
      <view class="uni-group">
        ...
        <button v-if="hasPermission('CREATE_UNI_CMS_CATEGORIES')" class="uni-button" type="primary" size="mini"
          @click="navigateTo('./add')">新增</button>
        <button v-if="hasPermission('DELETE_UNI_CMS_CATEGORIES')" class="uni-button" type="warn" size="mini"
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="name,description,icon,sort,article_count,create_date"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection"
          ...
          <uni-tr>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'description')" sortable
              @sort-change="sortChange($event, 'description')">描述</uni-th>
            ...
            <uni-th align="center" filter-type="timestamp" @filter-change="filterChange($event, 'create_date')" sortable
          ...
          <uni-tr v-for="(item, index) in data" :key="index">
            ...
            <uni-td align="center">
              <view class="uni-group">
                <button v-if="hasPermission('UPDATE_UNI_CMS_CATEGORIES')"
                  @click="navigateTo('./edit?id=' + item._id, false)" class="uni-button" size="mini"
                  type="primary">修改</button>
                <button v-if="hasPermission('DELETE_UNI_CMS_CATEGORIES')" @click="confirmDelete(item._id)"
